                        ...
                        <div className='flex'>
                            {services.map((item, index) => (
                                <div key={index} className='flex-[0_0_100%] min-w-0 md:flex-[0_0_calc(100%/3)] px-3'>
                                    <article className='bg-[#1e293b] text-white rounded-2xl p-6 space-x-4 h-full flex flex-col'>
                                        ...
                                        <div className='border-t border-gray-400 pt-4 flex items-center justify-between'>
                                            ...
                                            <a
                                                href={`https://wa.me/65993186739?text=Ol%C3%A1%2C+gostaria+de+saber+mais+informa%C3%A7%C3%B5es+sobre+${encodeURIComponent(
                                                    item.title
                                                )}`}
                                                target='_blank'
